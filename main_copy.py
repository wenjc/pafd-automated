...
class Fudan:
    ...
    def login(self):
        ...
        headers = {
            ...
            "Referer": "https://zlapp.fudan.edu.cn/uc/wap/login/check",
            "User-Agent": self.UA
        }
...
if __name__ == '__main__':
    uid, psw = get_account()
    # print(uid, psw)
    zlapp_login = 'https://zlapp.fudan.edu.cn/uc/wap/login?check_auth=1&redirect=https://zlapp.fudan.edu.cn/site/fudanncov/TfudanDaily'
